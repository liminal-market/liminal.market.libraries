import ACHTransferAccountNumberHtml from "../../../../html/modal/Funding/FirstTransferSetup/ACHTransferAccountNumber.html";
...
export default class ACHTransferAccountNumber extends FirstTransferSetupBase {
  ...
  public bindEvents() {
    ...
    next?.addEventListener("click", (evt) => {
      ...
      let moneyTransferred = new MoneyTransferred(
        this.aUsdFund,
