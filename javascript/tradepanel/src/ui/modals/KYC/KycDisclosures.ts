...
export default class KycDisclosures extends KycBase {
  ...
  public bindEvents() {
    let is_affiliated_exchange_or_finra = document.getElementById(
    ...
    let is_control_person = document.getElementById(
      "is_control_person"
    ) as HTMLInputElement;
    ...
    let immediate_family_exposed = document.getElementById(
      "immediate_family_exposed"
    ) as HTMLInputElement;
    immediate_family_exposed?.addEventListener("click", (evt) => {
      this.loadPep("immediate_family_exposed");
    });
    let is_politically_exposed = document.getElementById(
  ...
  private validateFields() {
    ...
    if (
      ...
      this.setMissingInfo(
        "none_above_error",
        'You must select, "None of the above apply to me or my family." if nothing is selected',
        "none_above"
      );
      return false;
    }
    ...
    if (
      ...
      this.setMissingInfo(
        "none_above_error",
        'You cannot have "None of the above apply to me or my family." selected and other options selected. Please select only one',
        "none_above"
      );
      return false;
    }
