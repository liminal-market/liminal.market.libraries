...
export default class KycEditNameForm {
  ...
  private bindEvents() {
    ...
    kycEditNameConfirm?.addEventListener("click", async (evt) => {
      let given_name = document.getElementById(
        "given_name"
      ) as HTMLInputElement;
      let middle_name = document.getElementById(
        "middle_name"
      ) as HTMLInputElement;
      let family_name = document.getElementById(
        "family_name"
      ) as HTMLInputElement;
    ...
    let confirm_name = document.getElementById(
      "confirm_name"
    ) as HTMLInputElement;
    if (!confirm_name) {
      //TODO: report error in form
    ...
    let kycEditNameSave = document.getElementById(
      "kycEditNameSave"
