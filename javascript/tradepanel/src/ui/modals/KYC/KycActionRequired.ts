...
export default class KycActionRequired {
  ...
  public async show() {
    ...
    let kycActionRequiredForm = document.getElementById(
      "kycActionRequiredForm"
    );
    kycActionRequiredForm?.addEventListener("submit", async (evt) => {
      ...
      await kycService
        ...
        .then(() => {
          let kycActionRequiredDiv = document.getElementById(
            "kycActionRequiredDiv"
          ) as HTMLElement;
          kycActionRequiredDiv?.classList.add("hidden");

          let kycActionRequiredSubmittedDiv = document.getElementById(
            "kycActionRequiredSubmittedDiv"
          ) as HTMLElement;
  ...
  private hideError() {
    let kycActionRequiredError = document.getElementById(
      "kycActionRequiredError"
    );
